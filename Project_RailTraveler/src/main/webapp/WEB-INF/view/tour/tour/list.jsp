...
<div class="container">
 <div class="row" style="width: 25%">
        <div class="col" style="font-size: 18px; font-weight: 600;">
          <ul class="nav nav-tabs">
            <li class="nav-item active">
              <a class="nav-link active" href="<%=cp%>/main">전체</a>
            </li>
           
            <li class="nav-item ">
              <a class="nav-link active" href="<%=cp%>/main">관광</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" href="#">맛집</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" href="#">숙소</a>
            </li>
	...
	<div style="border: 1px solid black; border-radius: 20px; height: 80px; width: 90%; margin-left: 5% ;margin-bottom: 7%">
		...
		<button type="submit" class="btn"
  	    ...
  	    <div class="col-sm-6 col-md-4" style="max-width: 25%; min-height:300px ">
    <div class="thumbnail" >
      ...
      <div class="caption">
        <h3>테스트</h3>
        <p>...</p>
        <p align="right"><button  class="btn ">알아보기</button></p>
      </div>
    </div>
  </div>
    ...
    <div class="thumbnail" >
      <img style="height: 200px; width: 300px" src="<%=cp%>/resource/images/tour/samplehotel.jpg">
    ...
    <div class="thumbnail" >
      ...
      <div class="caption">
        <h3>강릉펜션</h3>
        <p>...</p>
        <p align="right"><button  class="btn btn-info">알아보기</button></p>
      </div>
    </div>
  </div>
