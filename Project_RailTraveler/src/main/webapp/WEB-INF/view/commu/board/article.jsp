...
<div class="body-content-container">
		...
		<table
			...
			<tr>
				<td colspan="3" style="padding-top: 15px;">
					<h3 style="margin: 10px 0 2px; font-size: 25px;">자유게시판의 공지입니다.</h3>
				</td>
			</tr>
			...
			<tr>
				<td colspan="3" style="padding: 20px 5px;" valign="top" height="200">
					내용입니드아아아 내용입니드아아아 내용입니드아아아 내용입니드아아아 내용입니드아아아 내용입니드아아아</td>
			</tr>
	...
	<div>
		<table
			style='width: 100%; margin: 15px auto 10px; border-spacing: 0px;'>
			<tr height='30'>
				<td align='left'><span style='font-weight: bold;'>댓글쓰기</span><span>
						- 타인을 비방하거나 개인정보를 유출하는 글의 게시를 삼가 주세요.</span></td>
			</tr>
			<tr>
				<td style='padding: 5px 0px 0px;'><textarea class='boxTA'
		...
		<div id="listReply">
			...
			<table
				style='width: 100%; margin: 10px auto 30px; border-spacing: 0px;'>
				<thead id='listReplyHeader'>
					<tr height='35'>
						<td colspan='2'>
							<div style='clear: both;'>
								<div style='float: left;'>
									<span style='color: #3EA9CD; font-weight: bold;'>댓글 1개</span> <span>[댓글
										목록, 1/1 페이지]</span>
								</div>
				...
				<tbody id='listReplyBody'>
					<tr height='35' style='background: #eeeeee;'>
						...
						<td width='50%'
							...
							align='right'><span>2019-12-16 18:03:22</span> | <span
							class="deleteReply" style="cursor: pointer;" data-replyNum='0'
							data-pageNo='0'>삭제</span> <span class="notifyReply">신고</span></td>
					</tr>
					<tr>
						<td colspan='2' valign='top' style='padding: 5px 5px;'>
							2019-12-16 18:03:22</td>
					</tr>
					...
					<tr>
						<td style='padding: 7px 5px;'>
							<button type='button' class='btn btnReplyAnswerLayout'
								data-replyNum='0'>
								답글 <span id="answerCount$0">1</span>
							</button>
						</td>
						<td style='padding: 7px 5px;' align='right'>
							<button type='button' class='btn btnSendReplyLike'
								data-replyNum='0' data-replyLike='1' title="좋아요">
								<i class="far fa-hand-point-up"></i> <span>3</span>
							</button>
							<button type='button' class='btn btnSendReplyLike'
								data-replyNum='0' data-replyLike='0' title="싫어요">
								<i class="far fa-hand-point-down"></i> <span>0</span>
							</button>
						</td>
					</tr>
					...
					<tr class='replyAnswer' style='display: none;'>
						<td colspan='2'>
							<div id='listReplyAnswer$0' class='answerList'
									...
									<div style='clear: both; padding: 10px 0px;'>
										...
										<div style='float: left; width: 95%;'>
											...
											<div style='float: right;'>
												<span>2019-12-16 18:03:22</span> | <span
													class='deleteReplyAnswer' style='cursor: pointer;'
													data-replyNum='0' data-answer='0'>삭제</span> <span
													class="notifyReply">신고</span>
											</div>
										</div>
									</div>
									<div
				...
				<tfoot id='listReplyFooter'>
					<tr height='40' align="left">
						<td colspan='2'>
							<button type="button" class="btn btn-default"
								onclick="javascript:location.href='/Project_RailTraveler/bbs/list?';">목록</button>
