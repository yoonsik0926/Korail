			...
			<table class="tb-created">
				...
				<c:if test="${mode=='update'}">
				   <c:forEach var="vo" items="${listFile}">
						  <tr id="f${vo.noticeFileNum}" height="40" style="border-bottom: 1px solid #cccccc;"> 
				...
				<tr>
					<td>
						<button type="button" class="btn btn-default"
							...
							onclick="javascript:location.href='<%=cp%>/notice/notice';">${mode=='update'?'수정취소':'등록취소'}</button>
