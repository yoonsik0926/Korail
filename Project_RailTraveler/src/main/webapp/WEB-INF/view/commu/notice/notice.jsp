...
<!-- 			<tr> -->
<!-- 				<td width="200" style="text-align: left;    vertical-align: bottom; -->
<!--     font-size: 14px;"></td> -->
<!-- 				<td width="600" style="text-align: right;"> -->
<%-- 					<form name="searchForm" action="<%=cp%>/notice/list" method="post" --%>
<!-- 						style="border: 1px solid #cccccc; height: 36px; border-radius: 3px; float: right;margin-right: 10px;"> -->
<!-- 						<select name="condition" class="boxTF" style="width: 30%;border-left: 0;"> -->
...
<!-- 							class="boxTF" style="display: inline-block; width: 58%;"> -->
<%-- 						<input type="image" src="<%=cp%>/resource/images/searchIcon.png" --%>
<!-- 							class="" onclick="searchList()" -->
<!-- 							style="padding: 6px; height: 100%; float: left; border-left: 1px solid #cccccc;"> -->
<!-- 					</form> -->
<!-- 				</td> -->
<!-- 				<td width="65" style="text-align: right;"><button type="button" class="btn btn-default" -->
<%-- 						onclick="javascript:location.href='<%=cp%>/notice/created';" --%>
<%-- 						style="float: left;"><img alt="" src="<%=cp%>/resource/images/editIcon.png" style="    height: 21px;"> 글쓰기</button></td> --%>
<!-- 			</tr> -->
		</table>
    ...
    <button type="button" class="btn btn-default"
						onclick="javascript:location.href='<%=cp%>/notice/created';"
						style="float: right;"><img alt="" src="<%=cp%>/resource/images/editIcon.png" style="    height: 21px;"> 글쓰기</button>
    <form name="searchForm" action="<%=cp%>/notice/list" method="post"
						style="border: 1px solid #cccccc; height: 36px; border-radius: 3px; float: right;margin-right: 6px;">
						<select name="condition" class="boxTF" style="width: 30%;height: 100%;border-left: 0;">
							<option value="all" ${condition=="all"?"selected='selected'":""}>모두</option>
							<option value="subject"
								${condition=="subject"?"selected='selected'":""}>제목</option>
							<option value="content"
			...
			<tbody style="border-bottom: 2px solid black;">
				...
				<tr class="lbo_li lbo_notice li_bg0 lbo_like">
					<td><img alt="" src="<%=cp%>/resource/images/noticeIcon.png"
						width="20"></td>
