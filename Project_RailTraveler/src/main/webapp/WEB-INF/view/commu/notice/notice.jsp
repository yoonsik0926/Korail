			...
			<thead>
				<tr>
					<td width="200" colspan="5"
						...
						style="display: block; float: left; font-size: 16px; padding-top: 9px; vertical-align: bottom;">검색결과 <span style="color: red;">3569건 </span> <img alt="" src="<%=cp%>/resource/images/close_icon.png" style="background: #dadada;
    width: 20px;
    padding: 3px;
