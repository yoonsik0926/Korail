...
$(function(){
	...
	$("ul.nav-tabs li").click(function(){
		...
		var url = "<%=cp%>/bbs/mybbs?commuNum="+tab;
		location.href=url;
		...
		<div id="listCommu">
				...
				<thead>
					<tr>
						<td width="200" colspan="5"
							...
							<form name="searchForm" action="<%=cp%>/bbs/mybbs?${query}&commuNum=${commuNum}&page=${page}"
								method="post"
			...
			<div>
				<nav style="text-align: center;">
					<ul class="pagination">
						<li>${dataCount==0?"작성한 게시물이 없습니다.":paging}</li>
					</ul>
				</nav>
			</div>
