...
public class MailSender {
	...
	public MailSender() {
		...
		this.pathname = "c:"+File.separator+"temp"+File.separator+"mail"; //임시 경로
	}
	...
	private class SMTPAuthenticator extends javax.mail.Authenticator {
         ...
         // 네이버 : 메일 아래부분 환경설정 클릭후 POP3등을 허용
	          ...
	          String username =  "railtraveler12@gmail.com";
	          String password = "railtraveler$!"; 
	...
	public boolean mailSend(Mail dto) {
		...
		p.put("mail.smtp.user", "railtraveler12");   
